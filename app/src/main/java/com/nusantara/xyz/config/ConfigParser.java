...
import com.nusantara.xyz.util.FileUtils;
...
import com.nusantara.xyz.util.securepreferences.crypto.Cryptor;
import com.nusantara.xyz.util.securepreferences.model.SecurityConfig;
import java.util.ArrayList;
import com.nusantara.xyz.util.Cripto;
	...
	public static boolean convertInputAndSave(InputStream input, Context mContext)
		...
		try {
			...
			try {
				...
				String dnsResolver1 = mConfigFile.getProperty(Settings.DNSRESOLVER_KEY);
				String dnsResolver2 = mConfigFile.getProperty(Settings.DNSRESOLVER_KEY2);
				settings.setVpnDnsForward(isDnsForward);
				settings.setVpnDnsResolver(dnsResolver1);
