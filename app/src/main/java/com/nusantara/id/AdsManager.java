...
public class AdsManager
{
	...
	private AdsManager(Context context){
		mContext = context;
		mPrefs = context.getSharedPreferences(NusantaraApp.PREFS_GERAL, Context.MODE_PRIVATE);
	...
	private void setupAdsInterstitial() {
		...
		if (!BuildConfig.DEBUG)
			mInterstitialAd.setAdUnitId(NusantaraApp.ADS_UNITID_INTERSTITIAL_MAIN);
		else
			mInterstitialAd.setAdUnitId("ca-app-pub-9870690854198040/5887367482");
